      ...
      <>
        <section className="programbox">
            <div className="programphrase">
                <div className="programphrase1">Eksplorasi Berbagai Program Nutrikid</div>
            ...
            <div className="card-group contentprogram">
                ...
                <img src="/homepage/100days.png" className="card-img-top imgpg1" alt="Baby" />
                ...
                <div className="card program1">
                <img src="/homepage/baby-food.jpg" className="card-img-top imgpg1" alt="Baby food" />
                <div className="card-body">
                    <h5 className="card-title titleprogram1">Makanan Sehat untuk Anak</h5>
                    <p className="card-text textisi">
                ...
                <div className="card program1">
                <img src="/homepage/nutrisi-ibu.jfif" className="card-img-top imgpg1" alt="Pregnant mom" />
                <div className="card-body">
                    <h5 className="card-title titleprogram1">
