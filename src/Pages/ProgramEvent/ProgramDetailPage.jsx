...
import {
  fetchOtherProgramsById,
  fetchProgramDetailsById,
  rupiah,
    ...
    <>
      <section className="d-flex align-items-center mt-5 mb-5 ms-5 me-5 justify-content-between program-detail-banner gap-5">
        <div className="w-75">
          ...
          <h4 style={{ color: programDetails.price === 0 ? "red" : "" }}>
            {rupiah(programDetails.price)}
          </h4>
          <button
            type="button"
      ...
      <section className="d-flex align-items-center mt-5 mb-5 ms-5 me-5 gap-3 justify-content-between program-detail-desc">
        <div>
          ...
          <ol>
            ...
            <li>
              Proyek akhir: Membuat perencanaan perawatan sesuai dengan
              kebutuhan bayi Anda
            </li>
          </ol>
        </div>
        <div className="d-flex row w-100 text-center gap-5">
          ...
          <div>
            ...
            <FaCalendarDays />
            <span className="ms-2">{programDetails.duration}</span>
          </div>
          <div>
            <h5>Jumlah Pendaftar</h5>
            <FaUsers />
            <span className="ms-2">30 Orang</span>
          </div>
          <div>
            <h5>Metode Pembelajaran</h5>
            <FaWifi />
            <span className="ms-2">Modul Online</span>
          </div>
        </div>
      </section>
        ...
        <div className="d-flex align-items-center mt-5 mb-5 me-5 gap-3">
          {speakers.map((speaker, index) => (
            ...
            >
              ...
              />
              <Card.Body>
                <Card.Title className="speaker-program-fullname">
                  {speaker.fullname}
                </Card.Title>
                <Card.Text className="speaker-program-firstname">
                  Dr. {speaker.firstname}
                </Card.Text>
                <Card.Text className="speaker-program-specialist">
                  {speaker.specialist}
                </Card.Text>
              </Card.Body>
            </Card>
      ...
      >
        ...
        <div className="w-75 mx-auto">
          <EventCarousel
            events={otherPrograms}
            onEventClick={handleProgramClick}
          />
        </div>
      </section>
    </>
